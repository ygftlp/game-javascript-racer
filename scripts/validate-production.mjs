...
requireTokens(uiLogo, ['RacerUiLogoOptions', 'class RacerUiLogo', 'render(ctx: CanvasRenderingContext2D', 'RACER_UI_THEME.brandLogo', 'drawLogoPlate', 'drawSpeedStripes', 'drawBadge', 'drawLogoText', 'roundedRectPath'], 'programmatic brand logo renderer', missing);
...
requireTokens(uiTheme, ['RACER_UI_THEME', 'brandLogo', 'plateTop', 'plateBottom', 'stripePrimary', 'badgeFill', 'titleStroke', 'buttonIcon', 'trackCard', 'settingCard', 'statusPill', 'icon', 'textOffsetRatio', 'iconSmallSize', 'smallRightOffset', 'fontSmallSize', 'accent', 'minimap', 'controls'], 'centralized UI theme tokens, brand logo tokens, and icon/card metrics', missing);
...
requireTokens(productionPlan, ['programmatic logo', 'brandLogo', 'theme-tokenized', 'programmatic icons', 'buttonIcon', 'settingCard', 'statusPill', 'dedicated track-select screen', 'dedicated settings screen', 'settings cards', 'status pill', 'control sensitivity', '舒适', '标准', '灵敏', 'selected track id', 'per track id', 'Finish the configured target lap count on each selectable track'], 'production completion plan brand logo, theme-tokenized icons, track-select, settings cards, and sensitivity docs', missing);
requireTokens(uiAgentSync, ['programmatic logo', 'brandLogo', 'theme-tokenized', 'programmatic icons', 'buttonIcon', 'settingCard', 'statusPill', 'dedicated track-select screen', 'dedicated settings screen', 'settings cards', 'status pill', 'control sensitivity', '舒适', '标准', '灵敏', 'selected track id', 'per track id'], 'UI polish multi-agent sync brand logo, theme-tokenized icons, track-select, settings cards, and sensitivity docs', missing);
