...
requireTokens(uiTheme, ['RACER_UI_THEME', 'buttonIcon', 'trackCard', 'settingCard', 'statusPill', 'icon', 'textOffsetRatio', 'iconSmallSize', 'smallRightOffset', 'fontSmallSize', 'accent', 'minimap', 'controls'], 'centralized UI theme tokens and icon/card metrics', missing);
...
requireTokens(productionPlan, ['theme-tokenized', 'programmatic icons', 'buttonIcon', 'settingCard', 'statusPill', 'dedicated track-select screen', 'dedicated settings screen', 'settings cards', 'status pill', 'control sensitivity', '舒适', '标准', '灵敏', 'selected track id', 'per track id', 'Finish the configured target lap count on each selectable track'], 'production completion plan theme-tokenized icons, track-select, settings cards, and sensitivity docs', missing);
requireTokens(uiAgentSync, ['theme-tokenized', 'programmatic icons', 'buttonIcon', 'settingCard', 'statusPill', 'dedicated track-select screen', 'dedicated settings screen', 'settings cards', 'status pill', 'control sensitivity', '舒适', '标准', '灵敏', 'selected track id', 'per track id'], 'UI polish multi-agent sync theme-tokenized icons, track-select, settings cards, and sensitivity docs', missing);
