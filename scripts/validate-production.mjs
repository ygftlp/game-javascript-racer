...
requireTokens(uiLayout, ['RacerMiniMapLayout', 'RacerTrackSelectLayout', 'RacerSettingsLayout', 'miniMapButton', 'sensitivityButton', 'joystickTouchArea', 'pathBounds', 'miniMapSize', 'miniMapTop', 'pauseGap'], 'RacerUiLayout publish layout, track select, and settings card layout', missing);
